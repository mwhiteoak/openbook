      ...
      ? [
          {
            ...
            items: [
              { name: t('navigation.users'), href: '/settings/users', icon: Users },
              { name: t('navigation.sharepoint'), href: '/settings/sharepoint', icon: Share2 },
            ],
          },
        ]
      : [
        ...
        >
          ...
          {!isCollapsed && currentUser && (
            <div className="px-3 py-2 rounded-md bg-sidebar-accent/50 text-xs">
              ...
              <p className="text-sidebar-foreground/60 truncate">{currentUser.email}</p>
            </div>
          )}
