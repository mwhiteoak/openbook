export const bnIN = {
  ...
  auth: {
    ...
    registerDesc: "Join Open Notebook",
  ...
  sources: {
    ...
    stageExtracting: "কনটেন্ট নিষ্কাশন চলছে",
    stageEmbedding: "এমবেডিং তৈরি হচ্ছে",
    stageTransforming: "ইনসাইট তৈরি হচ্ছে",
    stageCompleted: "সম্পন্ন হয়েছে",
    stageFailed: "ব্যর্থ",
  ...
  chat: {
    ...
    cachedLabel: "ক্যাশ করা",
    cachedTooltip: "এই উত্তরটি ক্যাশ থেকে দেওয়া হয়েছে। মডেলটি আবার চালাতে পুনর্জেনারেট ক্লিক করুন।",
    regenerate: "পুনর্জেনারেট",
    retrievedSources: "{count}টি উৎস পুনরুদ্ধার করা হয়েছে",
    matchVector: "সেম্যান্টিক",
    matchText: "কীওয়ার্ড",
  },
  searchPage: {
    askAndSearch: "জিজ্ঞাসা ও অনুসন্ধান",
  ...
  setupBanner: {
    ...
    noModelConfigured: "No AI model configured yet",
    noModelConfiguredDescription: "Add an API key and register a language model to start using notebooks, chat, and search.",
  },
  users: {
    title: "User Management",
    desc: "Invite team members and manage access",
    inviteUser: "Invite user",
    teamMembers: "Team members",
    inviteTitle: "Invite user",
    inviteDesc: "Create an account for a new team member.",
    name: "Name",
    email: "Email",
    ...
    removeDesc: "This will permanently delete {name} ({email}) and all their data. This cannot be undone.",
    remove: "Remove",
    ...
    removedSuccess: "User removed",
    removeFailed: "Failed to remove user",
    roleUpdated: "Role updated",
    roleUpdateFailed: "Failed to update role",
    fillAllFields: "Please fill in all fields",
    count: "{count} user",
    countPlural: "{count} users",
  },
  sharepoint: {
    title: "SharePoint Sync",
    desc: "Connect your SharePoint folder to import documents into notebooks",
    mvpNotice: "File browsing shows mock data. Real SharePoint integration requires Microsoft Graph API credentials (planned for next sprint).",
    connectionTitle: "Connection",
    connected: "Connected",
    notConnected: "Not connected",
    connectedTo: "Connected to {siteUrl}",
    siteUrlLabel: "SharePoint site URL",
    siteUrlPlaceholder: "https://company.sharepoint.com/sites/teamsite",
    folderPathLabel: "Folder path",
    folderPathPlaceholder: "/Shared Documents/Research",
    connect: "Connect",
    connecting: "Connecting...",
    disconnect: "Disconnect",
    siteUrlInfo: "Site URL",
    folderInfo: "Folder",
    browseTitle: "Browse files",
    browseDesc: "Select files to import as sources",
    refresh: "Refresh",
    ...
    import: "Import",
    importing: "Importing...",
    connectSuccess: "SharePoint connected",
    connectFailed: "Failed to connect",
    disconnectSuccess: "SharePoint disconnected",
    importQueued: "Queued {count} file(s) for import",
