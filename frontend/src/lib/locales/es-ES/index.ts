export const esES = {
  ...
  sources: {
    ...
    stageEmbedding: "Indexando contenido",
    stageTransforming: "Generando insights",
  ...
  chat: {
    ...
    cachedTooltip: "Esta respuesta proviene de la caché. Haz clic en Regenerar para volver a ejecutar el modelo.",
    regenerate: "Regenerar",
    retrievedSources: "{count} fuentes recuperadas",
    matchVector: "Semántica",
    matchText: "Palabra clave",
  },
  searchPage: {
    askAndSearch: "Preguntar y buscar",
