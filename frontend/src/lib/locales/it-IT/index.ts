export const itIT = {
  ...
  sources: {
    ...
    stageQueued: "In coda",
    stageExtracting: "Estrazione contenuto",
    stageEmbedding: "Indicizzazione contenuto",
    stageTransforming: "Generazione insight",
  ...
  chat: {
    ...
    cachedLabel: "In cache",
    cachedTooltip: "Questa risposta proviene dalla cache. Fai clic su Rigenera per eseguire di nuovo il modello.",
    regenerate: "Rigenera",
    retrievedSources: "{count} fonti recuperate",
    matchVector: "Semantica",
    matchText: "Parola chiave",
  },
  searchPage: {
    askAndSearch: "Chiedi e cerca",
