export const ptBR = {
  ...
  sources: {
    ...
    stageEmbedding: "Indexando conteúdo",
    stageTransforming: "Gerando insights",
  ...
  chat: {
    ...
    cachedTooltip: "Esta resposta veio do cache. Clique em Regenerar para executar o modelo novamente.",
    regenerate: "Regenerar",
    retrievedSources: "{count} fontes recuperadas",
    matchVector: "Semântica",
    matchText: "Palavra-chave",
  },
  searchPage: {
    askAndSearch: "Perguntar e Buscar",
