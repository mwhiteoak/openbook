export const ruRU = {
  ...
  sources: {
    ...
    stageEmbedding: "Создание эмбеддингов",
    stageTransforming: "Генерация инсайтов",
  ...
  chat: {
    ...
    cachedLabel: "Из кэша",
    cachedTooltip: "Этот ответ получен из кэша. Нажмите «Перегенерировать», чтобы снова запустить модель.",
    regenerate: "Перегенерировать",
    retrievedSources: "Получено {count} источников",
    matchVector: "Семантика",
    matchText: "Ключевое слово",
  },
  searchPage: {
    askAndSearch: "Запрос и поиск",
