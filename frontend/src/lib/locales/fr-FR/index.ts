export const frFR = {
  ...
  sources: {
    ...
    stageEmbedding: "Indexation sémantique",
    stageTransforming: "Génération d'insights",
  ...
  chat: {
    ...
    cachedTooltip: "Cette réponse provient du cache. Cliquez sur Régénérer pour relancer le modèle.",
    regenerate: "Régénérer",
    retrievedSources: "{count} sources récupérées",
    matchVector: "Sémantique",
    matchText: "Mot-clé",
  },
  searchPage: {
